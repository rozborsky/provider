...
public interface DAO {
    int addUser(String name, String secondName, String address, long registrationDate, String eMail);
    ...
    void takeFee(int idUser, BigDecimal money);
    long getDateLastPayment(int idUser);
